...
public class RedirectToAuthenticationPreFilter extends ZuulFilter {
	...
	public Object run() {
		...
		// if (!hasRole)// if the user has already logged in, they will have a cookie
		// named role
		// {
		...
		// } else {
		// if (requestURI.length() > 7 && requestURI.substring(requestURI.length() -
		// 8).equals("caliber/"))// ends
		// // with
		// // caliber/
		...
		// }
		// } else
		// context.put("requestURI", "forward:/security/authorize");// anything that is
		// not one of those endpoints
		// // goes here
		// }
